...
import (
	...
	"github.com/zobstory/cakebear/internal/astnav"
	...
	"github.com/zobstory/cakebear/internal/debug"
	"github.com/zobstory/cakebear/internal/format"
	"github.com/zobstory/cakebear/internal/jsnum"
	"github.com/zobstory/cakebear/internal/locale"
	"github.com/zobstory/cakebear/internal/ls/autoimport"
	"github.com/zobstory/cakebear/internal/ls/change"
	"github.com/zobstory/cakebear/internal/ls/lsutil"
	"github.com/zobstory/cakebear/internal/lsp/lsproto"
	"github.com/zobstory/cakebear/internal/nodebuilder"
...
func (l *LanguageService) getPresentMemberModifiers(contextToken *ast.Node, file *ast.SourceFile, position int) presentMemberModifiers {
	...
	if rangePos < rangeEnd {
		eraseRange = new(l.createLspRangeFromBounds(rangePos, rangeEnd, file))
	}
