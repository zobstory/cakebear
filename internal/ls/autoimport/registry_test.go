...
import (
	...
	"github.com/zobstory/cakebear/internal/testutil/autoimporttestutil"
	"github.com/zobstory/cakebear/internal/testutil/projecttestutil"
...
func TestHiddenDirectoriesInNodeModules(t *testing.T) {
	...
	t.Run("deep import through subdirectory package.json in hidden store", func(t *testing.T) {
		...
		// See https://github.com/zobstory/cakebear/issues/2780
		t.Parallel()
