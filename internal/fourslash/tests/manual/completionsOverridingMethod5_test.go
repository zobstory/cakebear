...
func TestCompletionsOverridingMethod5(t *testing.T) {
	t.Parallel()
		...
		Items: &fourslash.CompletionsExpectedItems{
			Includes: []fourslash.CompletionsExpectedItem{
				&lsproto.CompletionItem{
					Label:      "met",
					InsertText: new("met(n: string): void {\n}"),
					FilterText: new("met"),
					SortText:   new(string(ls.SortTextLocationPriority)),
				},
				&lsproto.CompletionItem{
					Label:      "met2",
					InsertText: new("met2(n: number): void {\n}"),
					FilterText: new("met2"),
					SortText:   new(string(ls.SortTextLocationPriority)),
				},
			},
	...
	f.VerifyCompletions(t, "b", &fourslash.CompletionsExpectedList{
		...
		Items: &fourslash.CompletionsExpectedItems{
			Includes: []fourslash.CompletionsExpectedItem{
				&lsproto.CompletionItem{
					Label:               "met",
					InsertText:          new("abstract met(n: string): void;"),
					FilterText:          new("met"),
					SortText:            new(string(ls.SortTextLocationPriority)),
				...
				&lsproto.CompletionItem{
					Label:               "met2",
					InsertText:          new("abstract met2(n: number): void;"),
					FilterText:          new("met2"),
					SortText:            new(string(ls.SortTextLocationPriority)),
					AdditionalTextEdits: fourslash.AnyTextEdits,
					Data: &lsproto.CompletionItemData{
	...
	f.VerifyCompletions(t, "c", &fourslash.CompletionsExpectedList{
		...
		Items: &fourslash.CompletionsExpectedItems{
			Includes: []fourslash.CompletionsExpectedItem{
				&lsproto.CompletionItem{
					Label:               "met",
					TextEdit:            InsertReplaceTextEdit("abstract met(n: string): void;", f.Ranges()[0].LSRange),
					FilterText:          new("met"),
					SortText:            new(string(ls.SortTextLocationPriority)),
					AdditionalTextEdits: fourslash.AnyTextEdits,
					Data: &lsproto.CompletionItemData{
				...
				&lsproto.CompletionItem{
					Label:               "met2",
					TextEdit:            InsertReplaceTextEdit("abstract met2(n: number): void;", f.Ranges()[0].LSRange),
					FilterText:          new("met2"),
					SortText:            new(string(ls.SortTextLocationPriority)),
					AdditionalTextEdits: fourslash.AnyTextEdits,
					Data: &lsproto.CompletionItemData{
