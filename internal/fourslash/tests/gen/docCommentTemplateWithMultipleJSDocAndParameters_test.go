...
// To modify this test, run "npm run makemanual docCommentTemplateWithMultipleJSDocAndParameters"
...
func TestDocCommentTemplateWithMultipleJSDocAndParameters(t *testing.T) {
