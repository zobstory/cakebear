...
// To modify this test, run "npm run makemanual quickinfoVerbosityInterface2"
...
func TestQuickinfoVerbosityInterface2(t *testing.T) {
...
namespace Foo/*8*/ {
	...
	defer done()
	f.VerifyBaselineHoverWithVerbosity(t, map[string][]int{"1": {0, 1}, "2": {0, 1}, "3": {0, 1, 2}, "4": {0, 1}, "5": {0, 1, 2}, "6": {0, 1}, "7": {0, 1}, "8": {0, 1}})
}
