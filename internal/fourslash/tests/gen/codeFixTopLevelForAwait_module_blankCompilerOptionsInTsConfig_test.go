...
// To modify this test, run "npm run makemanual codeFixTopLevelForAwait_module_blankCompilerOptionsInTsConfig"
...
func TestCodeFixTopLevelForAwait_module_blankCompilerOptionsInTsConfig(t *testing.T) {
