...
// To modify this test, run "npm run makemanual codeFixTopLevelForAwait_module_compatibleCompilerOptionsInTsConfig"
...
func TestCodeFixTopLevelForAwait_module_compatibleCompilerOptionsInTsConfig(t *testing.T) {
