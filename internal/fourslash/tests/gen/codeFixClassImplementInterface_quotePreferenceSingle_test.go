...
// To modify this test, run "npm run makemanual codeFixClassImplementInterface_quotePreferenceSingle"
...
func TestCodeFixClassImplementInterface_quotePreferenceSingle(t *testing.T) {
