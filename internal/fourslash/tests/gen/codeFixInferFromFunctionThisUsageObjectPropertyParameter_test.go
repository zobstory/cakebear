...
// To modify this test, run "npm run makemanual codeFixInferFromFunctionThisUsageObjectPropertyParameter"
...
func TestCodeFixInferFromFunctionThisUsageObjectPropertyParameter(t *testing.T) {
