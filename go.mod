module github.com/zobstory/cakebear
...
require (
	...
	github.com/zobstory/buildbinary v0.0.0
...
tool (
	github.com/anchore/quill/cmd/quill
...
replace github.com/zobstory/buildbinary => ../buildbinary
